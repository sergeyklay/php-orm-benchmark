...
use OrmBench\Propel\Models\Posts as BasePosts;
use OrmBench\Propel\Models\PostsQuery as BasePostsQuery;
use OrmBench\Propel\Models\Map\CommentsTableMap;
use OrmBench\Propel\Models\Map\PostsTableMap;
...
abstract class Posts implements ActiveRecordInterface
{
    ...
    /**
     * Initializes internal state of OrmBench\Propel\Models\Base\Posts object.
     */
     ...
     * @return $this|\OrmBench\Propel\Models\Posts The current object (for fluent API support)
     */
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->commentssScheduledForDeletion !== null) {
                if (!$this->commentssScheduledForDeletion->isEmpty()) {
                    \OrmBench\Propel\Models\CommentsQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\OrmBench\Propel\Models\Posts
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\OrmBench\Propel\Models\Posts The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OrmBench\Propel\Models\Posts (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OrmBench\Propel\Models\Posts Clone of current object.
     * @throws PropelException
     */
    ...
    public function initCommentss($overrideExisting = true)
    {
        ...
        $this->collCommentss->setModel('\OrmBench\Propel\Models\Comments');
    }
