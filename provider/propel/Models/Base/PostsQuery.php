 ...
 *
 * @method     \OrmBench\Propel\Models\CommentsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PostsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \OrmBench\Propel\Models\PostsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\OrmBench\\Propel\\Models\\Posts', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \OrmBench\Propel\Models\Comments object
     *
     * @param \OrmBench\Propel\Models\Comments|ObjectCollection $comments the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($comments instanceof \OrmBench\Propel\Models\Comments) {
            return $this
            ...
            throw new PropelException('filterByComments() only accepts arguments of type \OrmBench\Propel\Models\Comments or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \OrmBench\Propel\Models\CommentsQuery A secondary query class using the current class as primary query
     */
    public function useCommentsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinComments($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Comments', '\OrmBench\Propel\Models\CommentsQuery');
    }
