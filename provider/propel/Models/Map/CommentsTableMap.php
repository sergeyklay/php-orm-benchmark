...
use OrmBench\Propel\Models\Comments;
use OrmBench\Propel\Models\CommentsQuery;
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \OrmBench\Propel\Models\Comments) { // it's a model object
