 ...
 *
 * @method     \OrmBench\Models\Propel\PostsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CommentsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \OrmBench\Models\Propel\Base\CommentsQuery object.
     *
    ...
    /**
     * Filter the query by a related \OrmBench\Models\Propel\Posts object
     *
     * @param \OrmBench\Models\Propel\Posts|ObjectCollection $posts The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($posts instanceof \OrmBench\Models\Propel\Posts) {
            return $this
            ...
            throw new PropelException('filterByPosts() only accepts arguments of type \OrmBench\Models\Propel\Posts or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \OrmBench\Models\Propel\PostsQuery A secondary query class using the current class as primary query
     */
    public function usePostsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPosts($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Posts', '\OrmBench\Models\Propel\PostsQuery');
    }
