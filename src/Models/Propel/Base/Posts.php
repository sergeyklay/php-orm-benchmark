...
use \Exception;
use \PDO;
use OrmBench\Models\Propel\Comments as BaseComments;
use OrmBench\Models\Propel\CommentsQuery as BaseCommentsQuery;
use OrmBench\Models\Propel\Posts as BasePosts;
use OrmBench\Models\Propel\PostsQuery as BasePostsQuery;
use OrmBench\Models\Propel\Map\CommentsTableMap;
 ...
 *
 * @package    propel.generator.OrmBench.Models.Propel.Base
 */
abstract class Posts implements ActiveRecordInterface
{
    ...
    /**
     * @var        ObjectCollection|BaseComments[] Collection to store aggregation of BaseComments objects.
     */
     ...
     * @var ObjectCollection|BaseComments[]
     */
    protected $commentssScheduledForDeletion = null;

    /**
     * Initializes internal state of OrmBench\Models\Propel\Base\Posts object.
     */
     ...
     * @return $this|\OrmBench\Models\Propel\Posts The current object (for fluent API support)
     */
    ...
    public function setBody($v)
    {
        ...
        if ($this->body !== $v) {
            $this->body = $v;
            $this->modifiedColumns[PostsTableMap::COL_BODY] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== $v) {
            $this->created_at = $v;
            $this->modifiedColumns[PostsTableMap::COL_CREATED_AT] = true;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== $v) {
            $this->updated_at = $v;
            $this->modifiedColumns[PostsTableMap::COL_UPDATED_AT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PostsTableMap::translateFieldName('Body', TableMap::TYPE_PHPNAME, $indexType)];
            $this->body = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PostsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PostsTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = BasePostsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = BasePostsQuery::create()
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->commentssScheduledForDeletion !== null) {
                if (!$this->commentssScheduledForDeletion->isEmpty()) {
                    \OrmBench\Models\Propel\CommentsQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PostsTableMap::COL_BODY)) {
            $modifiedColumns[':p' . $index++]  = 'body';
        }
        if ($this->isColumnModified(PostsTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(PostsTableMap::COL_UPDATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'created_at':
                        ...
                        break;
                    case 'updated_at':
                        $stmt->bindValue($identifier, $this->updated_at, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\OrmBench\Models\Propel\Posts
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\OrmBench\Models\Propel\Posts The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PostsTableMap::COL_BODY)) {
            $criteria->add(PostsTableMap::COL_BODY, $this->body);
        }
        if ($this->isColumnModified(PostsTableMap::COL_CREATED_AT)) {
            $criteria->add(PostsTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(PostsTableMap::COL_UPDATED_AT)) {
            $criteria->add(PostsTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = BasePostsQuery::create();
        $criteria->add(PostsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OrmBench\Models\Propel\Posts (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OrmBench\Models\Propel\Posts Clone of current object.
     * @throws PropelException
     */
    ...
    public function initCommentss($overrideExisting = true)
    {
        ...
        $this->collCommentss->setModel('\OrmBench\Models\Propel\Comments');
    }

    /**
     * Gets an array of BaseComments objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this BasePosts is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|BaseComments[] List of BaseComments objects
     * @throws PropelException
     */
    public function getCommentss(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collCommentss || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommentss) {
                ...
                $collCommentss = BaseCommentsQuery::create(null, $criteria)
                    ->filterByPosts($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of BaseComments objects related by a one-to-many relationship
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|BasePosts The current object (for fluent API support)
     */
    public function setCommentss(Collection $commentss, ConnectionInterface $con = null)
    {
        /** @var BaseComments[] $commentssToDelete */
    ...
    public function countCommentss(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collCommentss || null !== $criteria || $partial) {
            ...
            $query = BaseCommentsQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a BaseComments object to this object
     * through the BaseComments foreign key attribute.
     *
     * @param  BaseComments $l BaseComments
     * @return $this|\OrmBench\Models\Propel\Posts The current object (for fluent API support)
     */
    public function addComments(BaseComments $l)
    {
        if ($this->collCommentss === null) {
            $this->initCommentss();
            $this->collCommentssPartial = true;
    ...
    /**
     * @param BaseComments $comments The BaseComments object to add.
     */
    protected function doAddComments(BaseComments $comments)
    {
    ...
    /**
     * @param  BaseComments $comments The BaseComments object to remove.
     * @return $this|BasePosts The current object (for fluent API support)
     */
    public function removeComments(BaseComments $comments)
    {
